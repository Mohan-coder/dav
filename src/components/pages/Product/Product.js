            ...
            <div className="col-lg-7 col-md-7">
              <div className="product-details-text">
                ...
                <p className="onetime-cont"
                  ...
                  <Link target="_blank" to="/terms" style={{ color: '#116977' }}>
                    Terms and conditions
                  </Link>{" "}
                  &amp;{" "}
                  <Link target="_blank" to="/privacy" style={{ color: '#116977' }}>
                    Privacy policy
                  </Link>
