                        ...
                        <div class="col-md-12">
                            <center>
                                <div class="foot" id="quick-links">
                                    <p><Link to={"ingredients"}  rel='noopener noreferrer'>Ingredients</Link></p>
                                    <p><Link to={"terms"}  rel='noopener noreferrer'>Terms &amp; Conditions</Link></p>
                                    <p><Link to={"privacy"}  rel='noopener noreferrer'>Privacy Policy</Link></p>
                                    <p> <Link to={"contact"}  rel='noopener noreferrer'>Contact</Link> </p>
                                    {/* <!-- <p><a href="cancelletion" >Cancel Order</a></p> --> */}
                                </div>
                            </center>
